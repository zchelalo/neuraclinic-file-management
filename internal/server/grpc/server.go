...
func New(cfg Config, logger *zap.Logger, appServices *filesgrpc.Services) (*Server, error) {
	...
	filemanagementv1.RegisterFileManagementServiceServer(grpcServer, appServices.FileManagement)
